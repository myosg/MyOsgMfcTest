...
CMFCTestCodeDlg::CMFCTestCodeDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMFCTestCodeDlg::IDD, pParent)
{
...
void CMFCTestCodeDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
